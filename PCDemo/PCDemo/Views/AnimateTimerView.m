...
@implementation AnimateTimerView
...
- (void)animateWithDuration:(NSTimeInterval)duration WithCompletionBlock:(void(^)())completion {
    ...
    _currentTime = 0;
     ...
     _timer = [NSTimer scheduledTimerWithTimeInterval:1/60. target:self selector:@selector(updateTimer:) userInfo:nil repeats:YES];
}
